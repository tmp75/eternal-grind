...
export const LESSONS: Lesson[] = [
  ...
  { n: 52, tag: "MEETING", truth: "HALF LIE", rank: "Apprentice Grinder", xp: 85, title: "The Pre-Read Bluff",
    body: "Say 'I went through the pre-read.' Nobody made a pre-read. Now nobody can prove you didn't." },
  { n: 53, tag: "SLACK", truth: "BOTH", rank: "Senior Grinder", xp: 210, title: "The 4:47 PM Shipped Post",
    body: "Post 'just shipped' at 16:47. Don't say what. Close laptop at 16:48. Weekend earned in 60 seconds." },
  { n: 54, tag: "EMAIL", truth: "HALF TRUE", rank: "Smug Sigma", xp: 540, title: "Vacation Auto-Reply Forever",
    body: "Set the OOO. Never turn it off. People learn to route around you. INKO has been 'out' since 2021." },
  { n: 55, tag: "MEETING", truth: "HALF LIE", rank: "Apprentice Grinder", xp: 95, title: "The Standup Mute Cough",
    body: "Pretend to unmute. Cough. Re-mute. 'Sorry, you go first.' Standup ends. You said nothing. Promotion intact." },
  { n: 56, tag: "OPTICS", truth: "BOTH", rank: "Senior Grinder", xp: 230, title: "The Tab Wall",
    body: "Keep 47 tabs open at all times. Anyone glancing assumes deep grind. The browser is the alibi." },
  { n: 57, tag: "POSTURE", truth: "HALF TRUE", rank: "Intern", xp: 35, title: "The Confident Wrong Answer",
    body: "Answer with conviction even when wrong. Confidence beats correctness. Nobody fact-checks the smug." },
  { n: 58, tag: "CAREER", truth: "HALF LIE", rank: "Smug Sigma", xp: 610, title: "Quiet Promoting",
    body: "Update your LinkedIn title before your boss does. By the time they notice, the title is folklore." },
  { n: 59, tag: "NAP", truth: "HALF TRUE", rank: "Senior Grinder", xp: 270, title: "Eye-Mask in the Wellness Room",
    body: "Most offices have one. Few use it. INKO uses it daily. 'Migraine recovery.' Output: REM. Status: grinding." },
  { n: 60, tag: "SLACK", truth: "BOTH", rank: "INKO Disciple", xp: 1050, title: "The Async-Only Sigma",
    body: "Refuse synchronous comms. 'Async first.' Then never reply async either. The void is the medium." },
  { n: 61, tag: "BATHROOM", truth: "HALF LIE", rank: "Apprentice Grinder", xp: 110, title: "The Cross-Floor Pilgrimage",
    body: "Use a bathroom on a different floor. Adds 7 minutes each way. The stairs are the gym AND the grind." },
  { n: 62, tag: "CALENDAR", truth: "HALF TRUE", rank: "Senior Grinder", xp: 250, title: "Buffer Around Every Meeting",
    body: "15 min before, 15 min after. 'To prepare and decompress.' Activity: scroll. Effect: half the day is buffer." },
  { n: 63, tag: "EMAIL", truth: "HALF LIE", rank: "Senior Grinder", xp: 290, title: "Forward With No Note",
    body: "Forward a long thread to someone else. Add nothing. They now own it. You are off the hook. INKO smiles." },
  { n: 64, tag: "OPTICS", truth: "BOTH", rank: "Smug Sigma", xp: 670, title: "The Whiteboard Squiggle",
    body: "Walk into a meeting room. Draw three boxes and an arrow. Walk out. People will think you're shaping strategy." },
